...
{
	alert(idtestimonials);
 var deletess = confirm("Do you really want to delete");
  if(deletess == true)
  {
        
	 window.location = "deleteplacements.php?idtestimonials="+idtestimonials;
   }
}
</script>
</head>
        ...
        <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
				...
				<tr><td colspan="4" class="heading_new">Placement List</td></tr>
				<tr>
				<td>
...
<tr><td width="20%" valign="top">
 ...
 <tr><td align="right">
<a href="addplacements.php" class="blueButton">Add Placement</a></td></tr>
<tr><td>
...
$idachievers = $arraStudent[$s]['idacheievers'];
?>

<tr class="<?php echo $row_color?>">
<td><a href="editplacement.php?idachievers=<?php echo $idachievers;?>"> <?php echo $small = substr($arraStudent[$s]['name'], 0, 50);?></a></td>

<td><?php echo $arraStudent[$s]['batchno'];?></a></td>
						  <td><?php echo $arraStudent[$s]['company'];?></a></td>
						  <td>
				<a onclick="deletemanageprog(<?php echo $idachievers;?>)"><img src="../images/icon_delete.png" border="0" alt="Delete" align="right"/></a>
						  </td>
</tr>
