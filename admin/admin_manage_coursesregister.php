...
$resultsss = "SELECT * FROM  tbl_courseenquiries order by idcourseenquiries desc";
$arraStudent=array();
	...
	while ($row = mysql_fetch_assoc($resultc)) {
		 ...
		 $arraStudent[$s]["StudentPhone"]	= $row["mobile"];
		  $arraStudent[$s]["coursename"]	= $row["coursename"];
		 $arraStudent[$s]["idstudentdetailsinformation"]	= $row["idcourseenquiries"];
		  $s++;  
		}
?>
...
function deletemanageprog(idprog)
{
 var deletess = confirm("Do you really want to delete");
  if(deletess == true)
  {
	 ...
	 window.location = "deletestudentcoursesregister.php?idstudentdetailsinformation="+idprog;
   }
}
...
function deletemsg()
{
 var deletess = confirm("Do you really want to delete");
  if(deletess == true)
  {
	 ...
	 window.location = "deleteallstudentcoursesregister.php";
   }
}
...
<a href="importcourseplanner.php" class="blueButton">Export to Excel</a>
...
<td>
<?php echo $arraStudent[$s]['StudentName'];?>
				
</td>
<td><?php echo $arraStudent[$s]['StudentEmail'];?></td>
<td><?php echo $arraStudent[$s]['StudentPhone'];?></td>
<td><?php echo $arraStudent[$s]['coursename'];?></td>
						  <td>
