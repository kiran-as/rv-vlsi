...
$resultsss = "SELECT * FROM  tbl_registerstudents";
$arraStudent=array();
	...
	while ($row = mysql_fetch_assoc($resultc)) {
		 ...
		 $arraStudent[$s]["StudentPhone"]	= $row["Phoneno"];
		 	 $arraStudent[$s]["Title"]	= $row["Title"];
		 $arraStudent[$s]["idstudentdetailsinformation"]	= $row["idregisterstudents"];
		  $s++;  
		}
?>
...
function deletemanageprog(idprog)
{
 var deletess = confirm("Do you really want to delete");
  if(deletess == true)
  {
	 ...
	 window.location = "deletestudentsregister.php?idstudentdetailsinformation="+idprog;
   }
}
...
function deletemsg()
{
 var deletess = confirm("Do you really want to delete");
  if(deletess == true)
  {
	 ...
	 window.location = "deleteallstudentsregister.php";
   }
}
