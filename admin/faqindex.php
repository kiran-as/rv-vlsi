...
function deletemanageprog(idtestimonials)
{
 var deletess = confirm("Do you really want to delete");
  if(deletess == true)
  {
	 ...
	 window.location = "deletefaqheading.php?idfaqheading="+idtestimonials;
   }
}
</script>
</head>
        ...
        <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
				...
				<tr><td colspan="4" class="heading_new">FAQ's</td></tr>
				<tr>
				<td>
...
<tr><td width="20%" valign="top">
 ...
 <tr><td align="right">
<a href="addfaq.php" class="blueButton">Add Faq</a></td></tr>
<tr><td>
...
<td><a href="editfaq.php?idfaqheading=<?php echo $arraStudent[$s]['idfaqheading']?>"><?php echo $arraStudent[$s]['faqheadingname'];?></a></td>

						
						  <td>
				<a onclick="deletemanageprog(<?php echo $arraStudent[$s]['idfaqheading']?>)"><img src="../images/icon_delete.png" border="0" alt="Delete" align="right"/></a>
						  </td>
</tr>
