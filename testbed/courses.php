...
AND active =1 order by idprogramcalendar asc";
...
$arrprogramdetails[$k]["startmonth"]  = $row["startmonth"].' '.$row["Startyear"].' - '.$row["endmonth"].' '.$row["Endyear"];
...
<meta name="og:title" content="RV-VLSI Courses">
...
<meta property="og:title" content="RV-VLSI Courses" />
<meta property="og:description" content="RV-VLSI Courses" />
<meta property="og:type" content="article">
<meta property="og:url" content="http://rv-vlsi.com/courses.php"/>
<meta property="og:image" content="http://rv-vlsi.com/vlsi_img/marketing/course_page.jpg"/>
    <title>RV-VLSI Courses</title>
...
$(document).ready(function() {
  $.noConflict();
   ...
   $("#corporate_form").validate({
                ...
                messages: {
                    course_companyname: "<span>Please enter a Company Name</span>",
...
var url = "https://goo.gl/maps/kUqFe";
                    $('#courseThankYouMessage').html('<p>    Dear '+Name+'<br/>Thank you for enquiring at RV-VLSI .<br/>An email has been sent to your registered email Id. A counselor will get back to you shortly. You may also write to us at <a href="mailto:info@rv-vlsi.com">info@rv-vlsi.com</a> or call us at 080-40788574 / +91-7899-617-936 / +91-7899-617-941.<br/><a href="' + url + '" target="_blank">Click here for Direction</a><br/>Team RV-VLSI.</p>');
...
<?php include('vlsi_include/header.php') ;?>
    ...
    <h3 class="font36 txtc">VLSI PROGRAMS</h3> 
    <hr/>  
<div role="tabpanel">

  <!-- Nav tabs -->
<!--   <ul class="nav nav-tabs mar-t20 custom-tabs" role="tablist">
    <li role="presentation" class="active"><a href="#vlsi" aria-controls="students" role="tab" data-toggle="tab">VLSI Programs</a></li>
    <li role="presentation"><a href="#embedded" aria-controls="corporate" role="tab" data-toggle="tab">Embedded Programs</a></li>
  ...
  <div class="tab-content">
    ...
    <div role="tabpanel" class="tab-pane active" id="vlsi">                
<div role="tabpanel" class="pad-t10">
  <div class="row">
  <div class="col-sm-3">
  <!-- Nav tabs -->
  <ul class="nav nav-tabs faq-tabs course-tab" role="tablist">
    <li role="presentation" class="active"><a href="#faq1" aria-controls="faq1" role="tab" data-toggle="tab">VLSI - Full time Programs</a></li>
    <li role="presentation"><a href="#faq2" aria-controls="faq2" role="tab" data-toggle="tab">VLSI - Part Time Programs</a></li>   
...
<div role="tabpanel" class="tab-pane" id="embedded" style="display:none;">                
<div role="tabpanel" class="pad-t10">
  <div class="row">
  <div class="col-sm-3">
  <!-- Nav tabs -->
  <ul class="nav nav-tabs faq-tabs course-tab" role="tablist">
    <li role="presentation" class="active"><a href="#faq5" aria-controls="faq5" role="tab" data-toggle="tab">Embeded - Full Time Programs</a></li>
<!--     <li role="presentation"><a href="#faq6" aria-controls="faq6" role="tab" data-toggle="tab">Embeded - Part Time Program</a></li>   
 ...
 -->  </div>
  ...
  <div role="tabpanel" class="tab-pane" id="corporate" style="display:none;">                
<div role="tabpanel" class="pad-t10">
  <div class="row">
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body txtc" id='courseThankYouMessage' style='display:none'>
          <div class="form-group">    
            Thank you for showing interest .An email has been sent to your registered email Id. A counselor will get back to you shortly. You may also write to us at <a href="mailto:info@rv-vlsi.com">info@rv-vlsi.com</a> or call us at 080-40788574 / +91-7899-617-936 / +91-7899-617-941.<br/>

            <a href="https://goo.gl/maps/kUqFe" target="_blank">Click here for Direction</a>
          </div>   
      </div>
    </div>
  </div>
