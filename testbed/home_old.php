...
Systems Companies in &nbsp;&nbsp;the world.</p>
                    ...
                    <div class="item">
                        ...
                        <div class="pad-l40 pad-r20 pad-t20 white-title banner-copy">
                            <h1 class="font36">At RV-VLSI, Gain Skill and Experience</h1>
                           <p>&#8226; In VLSI and Embedded System Design.</p>
                            <p>&#8226; To know more about Learning@RV-VLSI <a href="learning-at-rv-vlsi.php">click Here</a></p>
                        </div>                         
                    </div>
            ...
            <div class="col-md-5 hpad10">
                <div class="row hmar5">
                    <div class="col-sm-6 hpad5 mar-b10">
                        <a href="vlsi-programs.php" class="flipcard white-title box2" style="height:225px;">
 <p class="face front"><span><strong style="font-size:25px";>VLSI PROGRAMS</strong></span></p>       
                        ...
                        <a href="embedded-program.php" class="flipcard white-title mar-t10 box4" style="height:225px;">
 <p class="face front"><span><strong style="font-size:25px";>EMBEDDED PROGRAMS</strong></span></p>       
                    ...
                    <div class="col-sm-6 hpad5">
                        <a href="testimonial.php" class="flipcard white-title box3" style="height:225px;">
 							<p class="face front"><span><strong style="font-size:25px";>PLACEMENTS</strong></span></p>       
                             <p class="face back">
                                 <span>
                                    <i id="carousel-example-company" class="carousel slide dblock overfl" data-ride="carousel" data-interval="3000">
                                        <i class="carousel-inner" role="listbox">
                                            ...
                                            <i class="item ifont" style="text-align:left;">
                                                "Impressed by teaching methodoloy and exposure to world class tools" <br/>  <i class="ifontby"> - V.Naveen Reddy</i><br/>
                                            </i>
                                            <i class="item ifont" style="text-align:left;">
                        ...
                        <h3 class="txtc font18 pad-t10">Enquiry Here</h3>
       ...
       <div class="clearfix">
                ...
                <div class="clearfix">
                  <div class="c-slider txtc">
                    ...
                    <div><span><img src="vlsi_img/intel.png" alt="" class="img-responsive"></span></div>        
      ...
      <div class="modal-body txtc">
            <div class="row hmar5">
                <div class="col-xs-6 col-sm-3 hpad5 mar-b10">
                    <img src="vlsi_img/customerlogos/single/1.png" class="img-responsive brd-all">
                </div>
                <div class="col-xs-6 col-sm-3 hpad5 mar-b10">
