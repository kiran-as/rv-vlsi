  <footer class="home-footer">
            <div class="container">
                <div class="sm-pull-right clearfix">
                   <p class="pull-left mar-r20 mar-t5"><a href='contact_us.php'>Contact Us</a></p>
                ...
                <p class="sm-pull-left pad-t5 pad-xs-t20 pad-b10">© <?php echo date('Y');?> Nanochip Solutions | RV-VLSI Design Center | <a href='privacy_policy.php'>Privacy Policy</a></p>
            </div>
        </footer>  
