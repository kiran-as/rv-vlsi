...
$sql = mysql_query("Select * from tbl_blog where industry_insights=1");
$i=0;
...
<meta property="og:title" content="Global Semiconductor Industry to see boosted growth from Automobile and Consumer Electronics Industry" />
<meta property="og:description" content="The automobile and consumer electronics industry is witnessing a revolution in Technological Advances. Automobiles and Consumer Electronic Devices are getting smarter, intelligent and safer. What is driving this transformation at the heart !!!! Its VLSI." />
<meta property="og:type" content="website">
<meta property="og:url" content="http://rv-vlsi.com/testbed/industry_insights.php"/>
...
$('#homepagetopform').hide();     
                     ...
                     var Message = 'Global Semiconductor Industry to see boosted growth from Automobile and Consumer Electronics Industry';
                     var URL = 'http://rv-vlsi.com/testbed/industry_insights.php';
       ...
       function insertIntoTable()
{
                    $('#detailsCommentForm').hide();
                     ...
                     var formData = 'name='+Name+'&email='+Email+'&mobileNumber='+MobileNumber+'&Comment='+Comment+'&industry_insights=1';
  ...
  <img id="loading-image" src="ajax-loader.gif" alt="Loading..." />
    ...
    <section class="container">
         <h3 class="font36 txtc">INDUSTRY INSIGHTS</h3> 
           ...
           <div class="row">
               <div class="col-sm-8">
                <h3 class="font24">Global Semiconductor Industry to see boosted growth from Automobile and Consumer Electronics Industry</h3>
...
<!--                         <li><a href="#" class="linkedin">linkedIn</a></li>
 -->                    </ul>
                ...
                <p class="pad-t10">The automobile and consumer electronics industry is witnessing a revolution in Technological Advances. Automobiles and Consumer Electronic Devices are getting smarter, intelligent and safer. What is driving this transformation at the heart !!!! Its VLSI.</p>
                <p class="pad-t10">Different types of semiconductor ICs are being used in a number of automotive products like navigation control, infotainment systems and collision detection systems. The growing demand for hybrid and electric vehicles (HEVs) due to increased environmental awareness and emissions legislations requires sophisticated processing and control units. The demand for driverless and smart cars will generate demand for advanced sensors over the next four years. This electrification and automation of automobiles have led to the increasing need for semiconductor wafers.</p>
                <p class="pad-t10">The demand for semiconductor ICs will further increase during the forecast period with advances like the emergence of 3D and ultra-high definition (UHD) TVs and hybrid laptops in the consumer electronics sector. This rise in demand for semiconductor ICs will, in turn, generate demand for semiconductor devices.</p>
                <p class="pad-t10">The semiconductor to grow at a CAGR of 6.42% until 2020. The increase in sales of microelectronics and consumer electronic devices is anticipated to support the growth of the semiconductor market.</p>
                <p style="font-size: 11px;">(Courtesy. <a href="http://electroiq.com/blog/2016/06/increased-use-of-semiconductors-in-the-auto-industry-will-boost-global-semiconductor-capital-equipment-until-2020/" target="_blank">Technovia</a>)</p>
                <hr/>
                <a href="#" data-toggle="modal" data-target="#detailsRegister" class="email">"Enroll for RV-VLSI's VLSI and Embedded Systems courses approved and certified by Electronics Sector Skill Council of India, NSDC, SKILL INDIA"</a>  
