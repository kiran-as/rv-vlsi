...
mysql_query("insert into tbl_rvstudent(name,phone,email,pgdip_coursename,resume_type,created_date,enquiry_from) values(
'".addslashes($name)."','".addslashes($mobile)."','".addslashes($email)."','999','RV-VLSI Website','$created_date','1003')") or die(mysql_error());
