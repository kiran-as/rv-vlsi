<?php
echo "<script>parent.location='rv-vlsi/index.php'</script>";
exit;
            ...
            <div class="col-sm-5 hpad10">
                <div class="row hmar5">
                    <div class="col-sm-6 hpad5 mar-b10">
                        <a href="vlsi-programs.php" class="course-block white-title">
                            <p class="c-hover"><span>VLSI Programs</span> (Advanced Diploma - Full time programs)</p>
                            <p class="c-readmore">Click Here</p>
                        </a>
                        <a href="embedded-program.php" class="course-block white-title mar-t10 box2">
                       ...
                       <p class="c-readmore">Click Here</p>
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <img src="vlsi_img/2.png" class="img-responsive" />
                            </div>
                            <div class="item">
                                <img src="vlsi_img/3.png" class="img-responsive" />
                            </div>
                            <div class="item">
                                <img src="vlsi_img/4.png" class="img-responsive" />
                            </div>   
                            <div class="item">
                                <img src="vlsi_img/5.png" class="img-responsive" />
                            </div>
                            <div class="item">
                                <img src="vlsi_img/6.png" class="img-responsive" />
                            </div>
                            <div class="item">
                                <img src="vlsi_img/7.png" class="img-responsive" />
                            </div>   
                            <div class="item">
                                <img src="vlsi_img/8.png" class="img-responsive" />
                            </div>
                            <div class="item">
                                <img src="vlsi_img/9.png" class="img-responsive" />
                            </div> 
                            <div class="item">
                                <img src="vlsi_img/10.png" class="img-responsive" />
                            </div>                                                                                                                                             
                        </div>                            
                        </div>                                               
                    </div>
                    <div class="col-sm-6 hpad5">
                        <a href="testimonial.php" class="course-block white-title box4">
