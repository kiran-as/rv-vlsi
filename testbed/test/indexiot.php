  ...
  // $('#hidden_link').hide();
    ...
    <style type="text/css">
     ...
     <!-- scripts links -->
       ...
       <script type="text/javascript" src="vlsi_js/jquery.min.js"></script>
     <script type="text/javascript" src="vlsi_js/classie.js"></script>
    <script type="text/javascript" src="vlsi_js/script.js"></script>
      
    <script src="vlsi_js/jquery.poptrox.min.js"></script>
    <script src="vlsi_js/skel.min.js"></script>
    <script src="vlsi_js/new-comp.js"></script>
...
<link rel="stylesheet" href="vlsi_css/colorbox.css" />

    

     <!-- End scripts links -->
     <link rel="stylesheet" type="text/css" href="vlsi_css/style.css">
         <?php if($mobile_browser=='200') {?>
        <!--pop-up scripts-->
       <link rel="stylesheet" href="vlsi_css/reveal.css">  
      
    <!-- Attach necessary scripts -->
    <!-- <script type="text/javascript" src="jquery-1.4.4.min.js"></script> -->
    <script type="text/javascript" src="http://code.jquery.com/jquery-1.6.min.js"></script>
    <script type="text/javascript" src="vlsi_js/jquery.reveal.js"></script>  
     <?php }?>
<script type="text/javascript">
...
font-size: 15px;"><b>Click here for more achievers</b></a>
          ...
          <p class="rgt-cntn-scndhme">
            ...
            <div class="clear"></div>
            <p class="clnt-imgs">
              <img alt="“Embedded Systems Training” “Embedded Training in Bangalore” “VLSI Training institutes” "   src="vlsi_images/logos/broadcom.png" > 
                        <img alt="“Embedded Systems Training” “Embedded Training in Bangalore” “VLSI Training institutes” "   src="vlsi_images/logos/ibm.png" >
                        <img alt="“Embedded Systems Training” “Embedded Training in Bangalore” “VLSI Training institutes” "   src="vlsi_images/logos/infosys.png" >
                        <img alt="“Embedded Systems Training” “Embedded Training in Bangalore” “VLSI Training institutes” "   src="vlsi_images/logos/intel.png" > 
                        <img alt="“Embedded Systems Training” “Embedded Training in Bangalore” “VLSI Training institutes” "   src="vlsi_images/logos/lsi.png" > 
              <?php if($mobile_browser=='200') {?>
                        <a href="#" data-reveal-id="myModal1"><img alt="“Embedded Systems Training” “Embedded Training in Bangalore” “VLSI Training institutes” "   style="margin-right:0px;" src="vlsi_images/logos/viewall.png" ></a>
                        <?php }?>
                         </p>
              
<div class="clear"></div>
            <div class="new-btch">
            <span>New batch starts in <span class="july-mnth">July</span> </span> <br />
            <a class="chfe" href="#slide6" >Click Here for More information on Upcoming Batches</a><img alt="“Embedded Systems Training” “Embedded Training in Bangalore” “VLSI Training institutes” "   src="vlsi_images/li.png" style="vertical-align: middle;margin: 0 0 0 5px;" />
            </div>
            <div class="clear"></div>
 ...
 <p style="text-align:center;font-weight:bold; font-size:22px;font-family:sans-serif; line-height:21px;">RV-VLSI ANNOUNCES THE START OF ADVANCED DIPLOMA IN EMBEDDED SYSTEMS(ADEMS) IN MAY</p>
...
<img src='vlsi_images/customerlogos/embedded/wipro.png' style='width:150px'>
<img src='vlsi_images/customerlogos/embedded/accenture.png' style='width:150px'>
<img src='vlsi_images/customerlogos/embedded/bosch.png' style='width:150px'>
<img src='vlsi_images/customerlogos/embedded/cognizant.png' style='width:150px'>
<img src='vlsi_images/customerlogos/embedded/cupol.png' style='width:150px'>
<img src='vlsi_images/customerlogos/embedded/del.png' style='width:150px'>
<img src='vlsi_images/customerlogos/embedded/hcl.png' style='width:150px'>

<img src='vlsi_images/customerlogos/embedded/ibm.png' style='width:150px'>&nbsp;
<img src='vlsi_images/customerlogos/embedded/infosys.png' style='width:150px'>
<img src='vlsi_images/customerlogos/embedded/indian.png' style='width:150px'>
<img src='vlsi_images/customerlogos/embedded/radel.png' style='width:150px'>
<img src='vlsi_images/customerlogos/embedded/kpit-cummins.png' style='width:150px'>
<img src='vlsi_images/customerlogos/embedded/arete.png' style='width:150px'>
<img src='vlsi_images/customerlogos/embedded/audience.png' style='width:150px'>
<img src='vlsi_images/customerlogos/embedded/lekha.png' style='width:150px'>
<span style=" color: #019885;font-weight: bold;"></p>   
    ...
    <section id="slide3" class="main style1 right dark fullscreen" style="">
        ...
        <div class="wh-we-r">
          ...
          <div class="rgt-po">  
            ...
            <img alt="“Embedded Systems Training” “Embedded Training in Bangalore” “VLSI Training institutes” "   class="cmpny-lgo" src="vlsi_images/broadcom.png" />
                        <img alt="“Embedded Systems Training” “Embedded Training in Bangalore” “VLSI Training institutes” "   class="cmpny-lgo" src="vlsi_images/cypress.png" />
                        <img alt="“Embedded Systems Training” “Embedded Training in Bangalore” “VLSI Training institutes” "   class="cmpny-lgo" src="vlsi_images/ibm.png" />
                        <img alt="“Embedded Systems Training” “Embedded Training in Bangalore” “VLSI Training institutes” "   class="cmpny-lgo" src="vlsi_images/infosys.png" />
                        <img alt="“Embedded Systems Training” “Embedded Training in Bangalore” “VLSI Training institutes” "   class="cmpny-lgo" src="vlsi_images/intel.png" />
                        <img alt="“Embedded Systems Training” “Embedded Training in Bangalore” “VLSI Training institutes” "   class="cmpny-lgo" src="vlsi_images/lsi.png" />
            <img alt="“Embedded Systems Training” “Embedded Training in Bangalore” “VLSI Training institutes” "   class="cmpny-lgo" src="vlsi_images/magma.png" />
                        <img alt="“Embedded Systems Training” “Embedded Training in Bangalore” “VLSI Training institutes” "   class="cmpny-lgo" src="vlsi_images/mentor-graphics.png" />
          
                     <a class="view-all-btn" href="#" data-reveal-id="myModal1">View All</a><br />
          <p class="wosp-tle">Students Pursuing Higher Studies at</p> 
            
            <img alt="“Embedded Systems Training” “Embedded Training in Bangalore” “VLSI Training institutes” "   class="uni-lgo" src="vlsi_images/cincinnati.png" />
            <img alt="“Embedded Systems Training” “Embedded Training in Bangalore” “VLSI Training institutes” "   class="uni-lgo" src="vlsi_images/illinois.png" />
                        <img alt="“Embedded Systems Training” “Embedded Training in Bangalore” “VLSI Training institutes” "   class="uni-lgo" src="vlsi_images/client-14.png" />
            <img alt="“Embedded Systems Training” “Embedded Training in Bangalore” “VLSI Training institutes” "   class="uni-lgo uni-sml" src="vlsi_images/syracuse.png" />
                        <img alt="“Embedded Systems Training” “Embedded Training in Bangalore” “VLSI Training institutes” "   class="uni-lgo" src="vlsi_images/client-15.png" />
                        <img alt="“Embedded Systems Training” “Embedded Training in Bangalore” “VLSI Training institutes” "   class="uni-lgo" src="vlsi_images/university-of-california.png" />
            <img alt="“Embedded Systems Training” “Embedded Training in Bangalore” “VLSI Training institutes” "   class="uni-lgo" src="vlsi_images/university-of-colorado.png" />
  ...
  <tr>
    <td align="left"> <textarea id="scont_msg" name="scont_msg" class="enq-reg-inpt rgt-reg-inpt"  value="" placeholder="Message"></textarea></td>
     <td align="left" class="vert-top"><span class="engineering-spn" style="font-family:'robotoregular';font-size:16px;"><img alt="“Embedded Systems Training” “Embedded Training in Bangalore” “VLSI Training institutes” " src="vlsi_images/phone.png" class="address-img">:+91-80-40788574&nbsp;&nbsp;&nbsp;&nbsp;<img alt="“Embedded Systems Training” “Embedded Training in Bangalore” “VLSI Training institutes” "   src="vlsi_images/email.png" class="address-img" /><a href="mailto:info@rv-vlsi.com" class="mailto-lnlk">info@rv-vlsi.com</a></td>
  </tr>
...
<div class="dmmy"></div>
 ...
 <div id="myModal1" class="reveal-modal">
    <table border="0" cellspacing="2" cellpadding="2" class="logogrid" width='800px;'>
                      <tr>
                        <td><img src="vlsi_images/customerlogos/single/1.png" width="200" height="100" /></td>
                        <td><img src="vlsi_images/customerlogos/single/2.png" width="200" height="100" /></td>
                        <td><img src="vlsi_images/customerlogos/single/3.png" width="200" height="100" /></td>
                      </tr>
                      <tr>
                        <td><img src="vlsi_images/customerlogos/single/4.png" width="200" height="100" /></td>
                        <td><img src="vlsi_images/customerlogos/single/5.png" width="200" height="100" /></td>
                        <td><img src="vlsi_images/customerlogos/single/6.png" width="200" height="100" /></td>
                      </tr>
                      <tr>
                        <td><img src="vlsi_images/customerlogos/single/7.png" width="200" height="100" /></td>
                        <td><img src="vlsi_images/customerlogos/single/8.png" width="200" height="100" /></td>
                        <td><img src="vlsi_images/customerlogos/single/9.png" width="200" height="100" /></td>
                      </tr>
                      <tr>
                        <td><img src="vlsi_images/customerlogos/single/10.png" width="200" height="100" /></td>
                        <td><img src="vlsi_images/customerlogos/single/11.png" width="200" height="100" /></td>
                        <td><img src="vlsi_images/customerlogos/single/12.png" width="200" height="100" /></td>
                      </tr>
                      <tr>
                        <td><img src="vlsi_images/customerlogos/single/13.png" width="200" height="100" /></td>
                        <td><img src="vlsi_images/customerlogos/single/14.png" width="200" height="100" /></td>
                        <td><img src="vlsi_images/customerlogos/single/15.png" width="200" height="100" /></td>
                      </tr>
                      <tr>
                        <td><img src="vlsi_images/customerlogos/single/16.png" width="200" height="100" /></td>
                        <td><img src="vlsi_images/customerlogos/single/17.png" width="200" height="100" /></td>
                        <td><img src="vlsi_images/customerlogos/single/18.png" width="200" height="100" /></td>
                      </tr>
                      <tr>
                        <td><img src="vlsi_images/customerlogos/single/19.png" width="200" height="100" /></td>
                        <td><img src="vlsi_images/customerlogos/single/20.png" width="200" height="100" /></td>
                        <td><img src="vlsi_images/customerlogos/single/21.png" width="200" height="100" /></td>
                      </tr>
                      <tr>
                        <td><img src="vlsi_images/customerlogos/single/22.png" width="200" height="100" /></td>
                        <td><img src="vlsi_images/customerlogos/single/23.png" width="200" height="100" /></td>
                        <td><img src="vlsi_images/customerlogos/single/24.png" width="200" height="100" /></td>
                      </tr>
                      <tr>
                        <td><img src="vlsi_images/customerlogos/single/25.png" width="200" height="100" /></td>
                        <td><img src="vlsi_images/customerlogos/single/26.png" width="200" height="100" /></td>
                        <td><img src="vlsi_images/customerlogos/single/27.png" width="200" height="100" /></td>
                      </tr>
                      <tr>
                        <td><img src="vlsi_images/customerlogos/single/28.png" width="200" height="100" /></td>
                        <td><img src="vlsi_images/customerlogos/single/29.png" width="200" height="100" /></td>
                        <td><img src="vlsi_images/customerlogos/single/30.png" width="200" height="100" /></td>
                      </tr>
                      <tr>
                        <td><img src="vlsi_images/customerlogos/single/31.png" width="200" height="100" /></td>
                        <td><img src="vlsi_images/customerlogos/single/32.png" width="200" height="100" /></td>
                        <td><img src="vlsi_images/customerlogos/single/33.png" width="200" height="100" /></td>
                      </tr>
                      <tr>
                        <td><img src="vlsi_images/customerlogos/single/34.png" width="200" height="100" /></td>
