<div role="tabpanel" class="tab-pane active" id="faq6">
            <ul class="list-group">
                <?php for($i=0;$i<count($embeddedPT);$i++){?>

                <li class="list-group-item">
                    <div class="row clearfix">
                        <div class="col-sm-5">
                           <div class="p-hover">
                  <a href="#" data-toggle="modal" data-target="<?php echo '#'.$embeddedPT[$i]['idprograms'];?>"><?php echo $embeddedPT[$i]['Title'];?></a>
                           <div class="p-block">
              ...
              <?php for ($k = 0; $k < count($arrprogramdetails); $k++)
                {
                    if ($arrprogramdetails[$k]['idprograms'] == $embeddedPT[$i]['idprograms'])
                      { ?>
            ...
            <?php }
              ...
              <div class="col-sm-2 xs-mar-t10">
                  <a href="#" data-toggle="modal" data-target="#detailsForm" class="btn btn-primary btn-block" onclick="fngetcoursename(<?php echo $embeddedPT[$i]['idprograms'];?>)">JOIN NOW</a>                
              </div>
                    </div>
                </li>
                <?php }?>
