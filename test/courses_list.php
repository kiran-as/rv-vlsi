...
$resultsss = "SELECT * FROM tbl_programs where Programtype=10 and Active=1 order by Orderforaltera";
	...
	while ($row = mysql_fetch_assoc($resultc)) {
		  ...
		  $vlsiFT[$s]["Description"]	= $row["Description"];
		   ...
		   $vlsiFT[$s]["Description"]	= $row["Description"];
$vlsiFT[$s]["no_of_students"]  = $row["no_of_students"];
$vlsiFT[$s]["course_duration"]  = $row["course_duration"];
$vlsiFT[$s]["placement"]  = $row["placement"];       
  ...
  while ($row = mysql_fetch_assoc($resultc)) {
      ...
      $vlsiPT[$s]["Description"]  = $row["Description"];
       $vlsiPT[$s]["Title"] = $row["Title"];
             $vlsiPT[$s]["Description"] = $row["Description"];
$vlsiPT[$s]["no_of_students"]  = $row["no_of_students"];
$vlsiPT[$s]["course_duration"]  = $row["course_duration"];
$vlsiPT[$s]["placement"]  = $row["placement"];       
      $s++;  
    } 
  ...
  while ($row = mysql_fetch_assoc($resultc)) {
      ...
      $vlsiCorporate[$s]["Description"] = $row["Description"];
       $vlsiCorporate[$s]["Title"]  = $row["Title"];
             $vlsiCorporate[$s]["Description"]  = $row["Description"];
 $vlsiCorporate[$s]["no_of_students"]  = $row["no_of_students"];
$vlsiCorporate[$s]["course_duration"]  = $row["course_duration"];
$vlsiCorporate[$s]["placement"]  = $row["placement"];       
      $s++;  
    }   
  ...
  while ($row = mysql_fetch_assoc($resultc)) {
      ...
      $embeddedFT[$s]["Description"] = $row["Description"];
       $embeddedFT[$s]["Title"]  = $row["Title"];
             $embeddedFT[$s]["Description"]  = $row["Description"];
$embeddedFT[$s]["no_of_students"]  = $row["no_of_students"];
$embeddedFT[$s]["course_duration"]  = $row["course_duration"];
$embeddedFT[$s]["placement"]  = $row["placement"];        
      $s++;  
    }     
  ...
  while ($row = mysql_fetch_assoc($resultc)) {
      ...
      $embeddedPT[$s]["Description"] = $row["Description"];
       $embeddedPT[$s]["Title"]  = $row["Title"];
             $embeddedPT[$s]["Description"]  = $row["Description"];
$embeddedPT[$s]["no_of_students"]  = $row["no_of_students"];
$embeddedPT[$s]["course_duration"]  = $row["course_duration"];
$embeddedPT[$s]["placement"]  = $row["placement"];        
      $s++;  
    }  
  ...
  while ($row = mysql_fetch_assoc($resultc)) {
      ...
      $embeddedVTU[$s]["Description"] = $row["Description"];
       $embeddedVTU[$s]["Title"]  = $row["Title"];
             $embeddedVTU[$s]["Description"]  = $row["Description"];
$embeddedVTU[$s]["no_of_students"]  = $row["no_of_students"];
$embeddedVTU[$s]["course_duration"]  = $row["course_duration"];
$embeddedVTU[$s]["placement"]  = $row["placement"];        
      $s++;  
    }     
  ...
  while ($row = mysql_fetch_assoc($resultc)) {
      ...
      $embeddedCorporate[$s]["Description"] = $row["Description"];
       $embeddedCorporate[$s]["Title"]  = $row["Title"];
             $embeddedCorporate[$s]["Description"]  = $row["Description"];
$embeddedCorporate[$s]["no_of_students"]  = $row["no_of_students"];
$embeddedCorporate[$s]["course_duration"]  = $row["course_duration"];
$embeddedCorporate[$s]["placement"]  = $row["placement"];       
      $s++;  
    }  
  ...
  while ($row = mysql_fetch_assoc($resultc)) {
      ...
      $allPrograms[$s]["Description"] = $row["Description"];
       $allPrograms[$s]["Title"]  = $row["Title"];
             $allPrograms[$s]["Description"]  = $row["Description"];
 $allPrograms[$s]["no_of_students"]  = $row["no_of_students"];
$allPrograms[$s]["course_duration"]  = $row["course_duration"];
$allPrograms[$s]["placement"]  = $row["placement"];       
      $s++;  
    }             
?>