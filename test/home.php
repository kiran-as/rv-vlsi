    ...
    var formData = 'name='+name+'&emailAddress='+emailAddress+'&city='+city+'&me='+me+'&msg='+msg+'&be='+be+'&other='+other+'&country='+country+'&state='+state+'&mobileNumber='+mobileNumber;
      $.ajax({
                ...
                success: function(result)
                {
                   ...
                   $('#homeenquiryIdRegisterDetails').html(' <p>    Dear '+name+' <br/>Thank you for enquiring at RV-VLSI<br/>An email has been sent to your registered email Id. A counselor will get back to you shortly. You may also write to us at <b>info@rv-vlsi.com</b> or call us at 080-40788574 / +91-7899-617-936 / +91-7899-617-941.<a href="' + url + '" target="_blank">Click here for Direction</a><br/>Team RV-VLSI.</p>');
                }
            });
}
...
function sendEmail()
{
    ...
    var formData = 'Name='+Name+'&Email='+Email+'&MobileNumber='+MobileNumber;
      ...
      $.ajax({
                ...
                {
                	var url = "https://goo.gl/maps/kUqFe";
                    $('#homeenquiryId').html(' <p>    Dear '+Name+'<br/>Thank you for enquiring at RV-VLSI<br/>An email has been sent to your registered email Id. A counselor will get back to you shortly. You may also write to us at <b>info@rv-vlsi.com</b> or call us at 080-40788574 / +91-7899-617-936 / +91-7899-617-941.<a href="' + url + '" target="_blank">Click here for Direction</a><br/>Team RV-VLSI.</p>');
                    $('#Name').val(' ');
                    $('#Email').val(' ');
                    $('#MobileNumber').val(' ');
                }
...
<div class="modal fade" id="42" tabindex="-1" role="dialog" aria-labelledby="myModal" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <span style="font-size:20px;"><h1>&nbsp;&nbsp;&nbsp;WISHING YOU A VERY HAPPY NEW YEAR - 2016</h1></span>
      <img src="vlsi_images/new year.jpg" style="margin-left:50px;" />
        </div>
      </div>
    </div>
  </div>
