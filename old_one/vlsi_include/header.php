    <header>
        <div class="navbar navbar-default top--header" role="navigation">
            <div class="container">
                <div class="row">                    
                        <a href="index.php" class="col-sm-2 logo"><span></span><img src="img/rv_institutes.png" class="img-responsive" /></a> 
                        <a href="index.php" class="col-sm-2 logo"><span></span><img src="img/rv_vlsi.png" class="img-responsive" /></a> 
                        <a href="index.php" class="col-sm-2 logo"><span></span><img src="img/nanochip.png" class="img-responsive" /></a>  
