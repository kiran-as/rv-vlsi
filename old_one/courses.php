...
<div role="tabpanel" class="pad-t10">
  ...
  <div class="col-sm-9">
      ...
      <p style="font-size: 15px;">Apart from our flagship program in VLSI, we also offer certificate courses focusing on a particular sub domain of VLSI as a specialization. The Details of the same are below.
</p>
...
<div role="tabpanel" class="pad-t10">
  ...
  <div class="col-sm-9">
      <div class="tab-content">
      <p style="font-size:15px;">Apart from our flagship program in embedded systems, we also offer certificate courses focusing on a particular sub domain of Embedded Systems as a specialization. The Details of the same are below.</p>
