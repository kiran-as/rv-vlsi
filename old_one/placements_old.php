...
$resultsss = "SELECT * FROM tbl_achievers order by order_batch desc";
...
<body>
    ...
    <section class="container">
           ...
           <hr/> 
              <h3 class="font18 txtc">We have had a history of excellent Placement records through our comprehensive placement assistance program that happens as a part of the VLSI and Embedded Systems Flagship Programs Respectively</h3>
            <p class="txtc pad-t10">Our placements are always in core companies and we take pride in having the highest number of such placements compared to any academic institution in India. Here are the Companies which have participated in our Placement Assistance Program</p>  
            <p class="txtc pad-t10">Here are few of our students who have been placed through our Placement Assistance Program. Detailed Information on Placement can be sought with our ADMIN Team in the Campus</p>     
