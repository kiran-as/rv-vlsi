...
.carousel-indicators li {
    ...
    border: 1px solid #029684 !important;
    border-radius: 10px;
    }
    ...
    height: 12px;
    margin: 0;
    background-color:#029684 !important;
}
</style>
...
color:#c72055;font-size: 15px;">Training Partner</span><img src="vlsi_img/nanochip.png" class="img-responsive" /></a>  
                        ...
                        <div class="navbar-right pad-t10">
                           ...
                           <div class="clearfix">
                                ...
                                <li><a href="work-at-rv-vlsi.php">Job@rv-vlsi</a></li>
                        ...
                        <span class="icon-bar"></span>
                         ...
                         <div id="navbar" class="navbar-collapse collapse clearfix">
                            <ul class="nav navbar-nav header-nav">
                                <li><a href="vlsi-programs.php" class="pad-sm-t13 pad-sm-b12">VLSI Programs</a>
                                </li>
                                <li><a href="embedded-program.php" class="pad-sm-t13 pad-sm-b12">EMBEDDED Programs</a>
                                </li>
 ...
 <li><a href="industry_insights.php" class="pad-sm-t13 pad-sm-b12 pad-r0">Industry Insights</a>
                                </li>
  ...
  <li data-target="#carousel-example-generic" data-slide-to="5"></li>    
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="item active">
                        <img src="vlsi_img/home_banner_new1.jpg" class="img-resposive" />                        
                    </div> 
                      <div class="item">
                        <img src="vlsi_img/home_banner_new2.jpg" class="img-resposive" />                        
                    </div>  
                    <div class="item">
                        <img src="vlsi_img/home_banner16.jpg" class="img-resposive" />
                        <div class="pad-l40 pad-r20 pad-t20 white-title banner-copy">
                           <h1 class="font36" style="font-size:30px;margin-top:280px;">RV-VLSI Initiatives Recognised by IESA</h1> 
                           <p>Dr Setty President RV Group receives the life time achievement award for contributions to skill development by Gurudev Sri Sri Ravishankar, Art of Living at the IESA Vision Summit in Bangalore. Also seen in the picture is Mr. Venkatesh Prasad CEO, RV-VLSI.</p>
                        </div>                         
                    </div>
 ...
 <div class="item">
                        ...
                        <div class="pad-l40 pad-r20 pad-t20 white-title banner-copy">
                            <h1 class="font36" style="margin-top:270px;">Momento to Venkatesh Prasad</h1> 
                           <p>Mr. Santosh Kumar, MD, TI India presents a momento to Venky Prasad, CEO RV-VLSI  at the IESA Vision Summit. Sri. P K Das, Director STPI looks on.
</p>
                        </div>                         
                    </div>
                   <!--  <div class="item">
       ...
       <div class="clearfix">
                ...
                <div class="clearfix">
                  <div class="c-slider txtc">
                    ...
                    <div><span><img src="vlsi_img/ur.png" alt="" style="height:90%;width:90%;" class="img-responsive"></span></div>
                    ...
                    <div><span><img src="vlsi_img/syracuse.png" style="height:90%;width:90%;" alt="" class="img-responsive"></span></div>                       
