...
function validation997()
	{
		 
		 var name=document.getElementById('cont_name997');
         var email=document.getElementById('cont_email997');
         var phone=document.getElementById('cont_mobile997');
        // var msg=document.getElementById('cont_msg');
		//var carmdl = $('#car_mdl').find(":selected").text();
		////////alert(name);
		 if(name.value.trim()== '')   
...
Add value to your academic degree by acquiring the skills to be industry ready or to prepare for higher studies abroad. We have a course that's right for you.                			</p>
							...
							<table width="100%" class="tble-for-corse" border="0" cellpadding="0" cellspacing="0">
								<tr style="background:#eef0f2;">
									<th class="med-curs frst-pading" colspan="3">RV-VLSI:Advanced Diploma and Diploma Programs</th>
								...
								<tr>
									...
									<a data-reveal-id="myModal991" class="big-link" href="#">RTL Design (Verilog) for FPGA Flow</a></td>
									<td>
								...
								<tr>
									<td class="reglr-curs frst-pading">
									<a data-reveal-id="myModal992" class="big-link" href="#">RTL Verification using System Verilog</a></td>
									<td>
								...
								<tr  id="Altera">
									<td class="reglr-curs frst-pading">
									<a data-reveal-id="myModal993" class="big-link" href="#">RTL Verification using UVM</a></td>
									<td>
								...
								<tr>
									<td class="reglr-curs frst-pading">
									<a data-reveal-id="myModal994" class="big-link" href="#">Static Timing Analysis in ASIC Design Flow</a></td>
									<td>
								...
								<tr>
									<td class="reglr-curs frst-pading" >
									<a data-reveal-id="myModal995" class="big-link" href="#">ASIC Physical Design ( PD) for Deep Submicron process nodes</a></td>
									<td>
								...
								<tr>
									<td class="reglr-curs frst-pading">
									<a data-reveal-id="myModal996" class="big-link" href="#">IC Mask (Analog) Layout Design</a></td>
									<td>
									<a data-reveal-id="myModal-btn996" class="big-link" href="#"><input class="coursesregistercursor" type="submit" name="join-now" value="Enquire Now" /></a></td>
								</tr>
								<tr>
									<td class="reglr-curs frst-pading" >
									<a data-reveal-id="myModal997" class="big-link" href="#">Fundamentals of Design for Test (DFT)</a></td>
									<td>
									<a data-reveal-id="myModal-btn997" class="big-link" href="#"><input class="coursesregistercursor" type="submit" name="join-now" value="Enquire Now" /></a></td>
								</tr>
...
<?php }?>
		  ...
		  <div id="myModal991" class="reveal-modal">
			<h1 style="color:red; font-size:26px;">1)RTL Design (Verilog) for FPGA Flow<br></h1>


            <br>
			<p>Industry standard sign-off tools from multiple EDA vendors. <br/>All courses will be delivered by VLSI professionals with hands on experience taping out multiple chips used in industry. 
			...
			<a class="close-reveal-modal">&#215;</a>
				  ...
				  <div id="myModal992" class="reveal-modal">
			<h1 style="color:red; font-size:26px;">RTL Verification using System Verilog<br></h1>
			...
			<a class="close-reveal-modal">&#215;</a>
				  ...
				  <div id="myModal993" class="reveal-modal">
			<h1 style="color:red; font-size:26px;">RTL Verification using UVM<br></h1>
			...
			<a class="close-reveal-modal">&#215;</a>
				  ...
				  <div id="myModal994" class="reveal-modal">
			<h1 style="color:red; font-size:26px;">Static Timing Analysis in ASIC Design Flow<br></h1>


            <br>
			<p>
			This program introduces the timing concepts needed to verify the timing correctness of ASIC Design Blocks. Timing issues typical to Deep sub-micron process nodeswill be covered in detail. Industry standard tools will be used in the labs. Importance of design constraints, timing exception, Setup and Hold checks for multimode multi corners will be discussed. OCV and AOCV issues are covered. Due focus on Signal Integrity and pre and post layout timing validation is given. Each participant will get the opportunity to practice concepts taught in the class during the concept labssessions followed by verifying the timing reports for a ASIC block of moderate complexity

            </p>
			<a class="close-reveal-modal">&#215;</a>
		</div>
		
				  <div id="myModal995" class="reveal-modal">
			<h1 style="color:red; font-size:26px;">ASIC Physical Design (PD) for Deep Submicron process nodes<br></h1>


            <br>
			<p>This program introduces you to the concepts used to design Chip-level and Block Level ASIC Layoutsfor Deep sub-micron process nodes using industry standard AP&R (Synopsys) tools. The various implementation steps from Netlist to GDS2 will be covered in detail. Every participant will get the opportunity to practice concepts taught in the class during the concept labs sessions. The course will conclude with a project done under the supervision of our leads</p>
			<a class="close-reveal-modal">&#215;</a>
		</div>
		
		 <div id="myModal996" class="reveal-modal">
			<h1 style="color:red; font-size:26px;">IC Mask (Analog) Layout Design<br></h1>


            <br>
			<p>This program introduces you to the layout design concepts for a DSM process node used to draw optimized layouts utilizing the least area and with the least layout parasiticsfor Standard Cells, Memory  cells and analog designs followed by Physical Verification of these layout using industry standard EDA tools will be covered.Topics such as Device Matching, DFM, LUP and ESD are covered.
Every participant will get the opportunity to practice concepts taught in the class during the concept labssessions. The course will conclude with a project done under the supervision of our leads
		 ...
		 <div id="myModal997" class="reveal-modal">
			<h1 style="color:red; font-size:26px;">Fundamentals of Design for Test (DFT)<br></h1>


            <br>
			<p>-	Engineers looking to work for Test engineering domains</p>
			<a class="close-reveal-modal">&#215;</a>
		</div>
...
<div id="myModal-btn991" class="reveal-modal">
			<h1 style="color:#f589aa; font-size:26px;">RTL Design (Verilog) for FPGA Flow<br></h1>
...
<tr style='display:none'>
   <td width="207"><input type="text"  class="input-txt" name="course_name991" id="course_name991" value='RTL Design (Verilog) for FPGA Flow'/></td>
  </tr>
  <tr>
...
<div id="myModal-btn992" class="reveal-modal">
			<h1 style="color:#f589aa; font-size:26px;">RTL Verification using System Verilog<br></h1>
...
<tr style='display:none'>
   <td width="207"><input type="text"  class="input-txt" name="course_name992" id="course_name992" value='RTL Verification using System Verilog'/td>
  </tr>
  <tr>
   <td><input type="submit"  name="formsubmit" class="send-button" value="Submit"/></td>
  </tr>
...
<div id="myModal-btn993" class="reveal-modal">
			<h1 style="color:#f589aa; font-size:26px;">RTL Verification using UVM<br></h1>
...
<tr style='display:none'>
   <td width="207"><input type="text"  class="input-txt" name="course_name993" id="course_name993" value='RTL Verification using UVM'/></td>
  </tr>
  <tr>
   <td><input type="submit"  name="formsubmit" class="send-button" value="Submit"/></td>
  </tr>
...
<div id="myModal-btn994" class="reveal-modal">
			<h1 style="color:#f589aa; font-size:26px;">Static Timing Analysis in ASIC Design Flow<br></h1>
...
<tr style='display:none'>
   <td width="207"><input type="text"  class="input-txt" name="course_name994" id="course_name994" value='Static Timing Analysis in ASIC Design Flow'/></td>
  </tr>
  <tr>
   <td><input type="submit"  name="formsubmit" class="send-button" value="Submit"/></td>
  </tr>
...
<div id="myModal-btn995" class="reveal-modal">
			<h1 style="color:#f589aa; font-size:26px;">ASIC Physical Design ( PD) for Deep Submicron process nodes<br></h1>
...
<tr style='display:none'>
   <td width="207"><input type="text"  class="input-txt" name="course_name995" id="course_name995" value='ASIC Physical Design ( PD) for Deep Submicron process nodes'/></td>
  </tr>
  <tr>
   <td><input type="submit"  name="formsubmit" class="send-button" value="Submit"/></td>
  </tr>
...
<div id="myModal-btn996" class="reveal-modal">
			<h1 style="color:#f589aa; font-size:26px;">IC Mask (Analog) Layout Design<br></h1>

  <form action="courseformmailer996.php"  name="cont_form" id="cont_form" method="POST" onsubmit="return validation996();">
            
           <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
   <td width="207"><input type="text"  class="input-txt" name="cont_name996" id="cont_name996" placeholder="Contact Name *"/></td>
  </tr>
  
  <tr>
    <td><input type="text"  class="input-txt" name="cont_mobile996" id="cont_mobile996" placeholder="Mobile  *"/></td> </tr>
  
   <tr>
      <td class="eml-disp" id="txtAge"><input type="text"  name="cont_email996" id="cont_email996" class="input-txt" placeholder="Email"/></td>
  </tr>
<tr style='display:none'>
   <td width="207"><input type="text"  class="input-txt" name="course_name996" id="course_name996" value='IC Mask (Analog) Layout Design'/></td>
  </tr>
  <tr>
   <td><input type="submit"  name="formsubmit" class="send-button" value="Submit"/></td>
  </tr>
...
<div id="myModal-btn997" class="reveal-modal">
			<h1 style="color:#f589aa; font-size:26px;">Fundamentals of Design for Test (DFT)<br></h1>

  <form action="courseformmailer997.php"  name="cont_form" id="cont_form" method="POST" onsubmit="return validation997();">
            
           <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
   <td width="207"><input type="text"  class="input-txt" name="cont_name997" id="cont_name997" placeholder="Contact Name *"/></td>
  </tr>
  
  <tr>
    <td><input type="text"  class="input-txt" name="cont_mobile997" id="cont_mobile997" placeholder="Mobile  *"/></td> </tr>
  
   <tr>
      <td class="eml-disp" id="txtAge"><input type="text"  name="cont_email997" id="cont_email997" class="input-txt" placeholder="Email"/></td>
  </tr>
<tr style='display:none'>
   <td width="207"><input type="text"  class="input-txt" name="course_name997" id="course_name997" value='Fundamentals of Design for Test (DFT)'/></td>
  </tr>
  <tr>
   <td><input type="submit"  name="formsubmit" class="send-button" value="Submit"/></td>
  </tr>
