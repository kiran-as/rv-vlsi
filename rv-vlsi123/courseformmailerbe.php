<?php
		include("application/conn.php");
					  ...
					  $sqlresult = mysql_query("Select * from tbl_project where idquestion=$idprogram");
					  while($row = mysql_fetch_assoc($sqlresult))
					  {
					    $course = $row['projectname'];
					  }
						...
						$subject='BE PROJECT: Register for '.$course;
				$headers  = 'MIME-Version: 1.0' . "\r\n";
				$headers .= "Content-Type: text/html; charset=ISO-8859-1\n";
				$headers .= 'From: RV-VLSI <info@rv-vlsi.com>';
				
  mysql_query("insert into tbl_beenquiries(coursename,name,mobile,email,upddatetime,ip) values('".addslashes($course)."',
...
echo "<script>parent.location='beproject.php'</script>";
exit; 													;
