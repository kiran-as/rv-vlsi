...
<script type="text/javascript">
 ...
 <table style="width:100%;border:0px;" >
  ...
  <article>
   ...
   <div class="contnr">
    <?php if($mobile_browser=='200') {?>
	<section id="slide1" class="" style="padding-top: 162px !important; padding-bottom: 100px;"><marquee>Congratulations and best wishes to ADAD and ADEMS students of RV-VLSI for securing placements at Sandisk, Intel and SmartPlay Mediatek.* Best wishes to students shortlisted at Dxcorr, Synopsys, Tata-Elxsi, Wipro, Infosys and Megachip.Please contact RV-VLSI for details. * Weekend Courses for Professionals seeking core jobs has started. Enquiry RV-VLSI for details
</marquee>
	<?php } else {?>
...
<div class="clear"></div>
						<div class="new-btch">
						<span>New batch starts in <span class="july-mnth">April</span> </span> <br />
 ...
 <p style="text-align:center;font-weight:bold; font-size:22px;font-family:sans-serif; line-height:21px;">RV-VLSI Partners with IESA to launch skill development programs for ESDM sector</p>
        <p style="padding-bottom:20px; padding-top:20px; line-height: normal;font-size: 14px;"><span style="font-weight:bold;">BENGALURU:</span>In a significant step, which is integral to ensuring the success of the ambitious ‘Make in India’ plan of the Indian government, the academia and the industry forum are partnering to create a readily available talent pool for the ESDM sector and the allied industries. Bengaluru-based RV-VLSI Design Centre, which is part of the RV Group of educational institutions, signed a Memorandum of Understanding (MoU) with the IESA (Indian Electronics & Semiconductor Association) to promote ESDM (Electronic System Design & Manufacturing) in the education sector and the academia.</p>
        <p style="padding-bottom:20px; line-height: normal;font-size: 14px;">The MoU was signed by IESA and the RV-VLSI on the second day of the 10th Vision Summit of the IESA in Bengaluru in the presence of the top honchos from the electronics and semiconductor industries.</p>   
        <p style="padding-bottom:20px; line-height: normal;font-size: 14px;">The objective of the MoU is to bridge the gap between academia and industry and to roll out courses, customized for the ESDM industry, to meet their talent requirement. In its initial stage, the courses will be introduced as a pilot in select academic institutions. The ESDM course will be offered by RV-VLSI in collaboration with Nanochip Solutions Pvt. Ltd. from the current academic year. At present, students, who have completed their engineering courses, will be eligible for the course. Going forward, the same will be extended to students, who are in the second semester of their engineering courses. The academia too will be trained in ESDM.</p>  
        <p style="line-height: normal;font-size: 14px;display:"><span style="font-weight:bold;">Mr. M.N. Vidyashankar, President, IESA</span>, said, <span style=" color: #019885;font-weight: bold;">“We signed this MoU with RV-VLSI because of its excellent educational infrastructure, legacy and its comfort level with the industry. Engineers trained at RV-VLSI have been absorbed by top companies in the world. We want our next talent pool for the ESDM to emerge out of the RV-VLSI. We have had a long relationship with the RV-VLSI and this MoU will strengthen it going forward. For India to embark on the Make in India journey, we need readily available talent pool and skilled work force. This MoU will help lower the barriers for engineers to acquire the knowledge and skills to help them plan their careers in VLSI and Embedded Systems and become employable for the ESDM sector."</span></p>   
        </div>                            
        <!--table border='1'>
        <tr>
