...
<div class="clear"></div>
						<div class="new-btch">
						<span>New batch starts in <span class="july-mnth">February</span> </span> <br />
...
<?php print_r($_SESSION);?>
      ...
      </a></div></div></div><a title="Close" class="fancybox-item fancybox-close" href="javascript:;"></a></div></div></div></div>
    <?php }?>
